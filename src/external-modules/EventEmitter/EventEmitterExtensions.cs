...
namespace Wechaty
{
    ...
    public static class EventEmitterExtensions
    {
        ...
        public static TEventEmitter RemoveListener<TEventEmitter>([DisallowNull] this TEventEmitter eventEmitter,
        ...
        /// <returns>Returns a reference to the EventEmitter, so that calls can be chained.</returns>
        [return: NotNullIfNotNull("eventEmitter")]
        public static TEventEmitter RemoveListener<TEventEmitter, T1>([DisallowNull] this TEventEmitter eventEmitter,
                                                       [DisallowNull] string eventName,
        ...
        /// <returns>Returns a reference to the EventEmitter, so that calls can be chained.</returns>
        [return: NotNullIfNotNull("eventEmitter")]
        public static TEventEmitter RemoveListener<TEventEmitter, T1, T2>([DisallowNull] this TEventEmitter eventEmitter,
                                                       [DisallowNull] string eventName,
        ...
        /// <returns>Returns a reference to the EventEmitter, so that calls can be chained.</returns>
        [return: NotNullIfNotNull("eventEmitter")]
        public static TEventEmitter RemoveListener<TEventEmitter, T1, T2, T3>([DisallowNull] this TEventEmitter eventEmitter,
                                                       [DisallowNull] string eventName,
        ...
        /// <returns>Returns a reference to the EventEmitter, so that calls can be chained.</returns>
        [return: NotNullIfNotNull("eventEmitter")]
        public static TEventEmitter RemoveListener<TEventEmitter, T1, T2, T3, T4>([DisallowNull] this TEventEmitter eventEmitter,
                                                       [DisallowNull] string eventName,
        ...
        /// <returns>Returns a reference to the EventEmitter, so that calls can be chained.</returns>
        [return: NotNullIfNotNull("eventEmitter")]
        public static TEventEmitter RemoveListener<TEventEmitter, T1, T2, T3, T4, T5>([DisallowNull] this TEventEmitter eventEmitter,
                                                       [DisallowNull] string eventName,
        ...
        /// <returns>Returns a reference to the EventEmitter, so that calls can be chained.</returns>
        [return: NotNullIfNotNull("eventEmitter")]
        public static TEventEmitter RemoveListener<TEventEmitter, T1, T2, T3, T4, T5, T6>([DisallowNull] this TEventEmitter eventEmitter,
                                                       [DisallowNull] string eventName,
        ...
        /// <returns>Returns a reference to the EventEmitter, so that calls can be chained.</returns>
        [return: NotNullIfNotNull("eventEmitter")]
        public static TEventEmitter RemoveListener<TEventEmitter, T1, T2, T3, T4, T5, T6, T7>([DisallowNull] this TEventEmitter eventEmitter,
                                                       [DisallowNull] string eventName,
        ...
        /// <returns>Returns a reference to the EventEmitter, so that calls can be chained.</returns>
        [return: NotNullIfNotNull("eventEmitter")]
        public static TEventEmitter RemoveListener<TEventEmitter, T1, T2, T3, T4, T5, T6, T7, T8>([DisallowNull] this TEventEmitter eventEmitter,
                                                       [DisallowNull] string eventName,
        ...
        /// <returns>Returns a reference to the EventEmitter, so that calls can be chained.</returns>
        [return: NotNullIfNotNull("eventEmitter")]
        public static TEventEmitter On<TEventEmitter>([DisallowNull] this TEventEmitter eventEmitter,
                                                      [DisallowNull] string eventName,
                                                      [DisallowNull] Delegate listener)
        ...
        /// <returns>Returns a reference to the EventEmitter, so that calls can be chained.</returns>
        [return: NotNullIfNotNull("eventEmitter")]
        public static TEventEmitter On<TEventEmitter, T1>([DisallowNull] this TEventEmitter eventEmitter,
                                                      [DisallowNull] string eventName,
                                                      [DisallowNull] Action<T1> listener)
            where TEventEmitter : IEventEmitter<TEventEmitter> => eventEmitter.On(eventName, ListenerWrapper.GetListenerWrapper(listener).Increment().Process);
        ...
        /// <returns>Returns a reference to the EventEmitter, so that calls can be chained.</returns>
        [return: NotNullIfNotNull("eventEmitter")]
        public static TEventEmitter On<TEventEmitter, T1, T2>([DisallowNull] this TEventEmitter eventEmitter,
                                                      [DisallowNull] string eventName,
                                                      [DisallowNull] Action<T1, T2> listener)
            where TEventEmitter : IEventEmitter<TEventEmitter> => eventEmitter.On(eventName, ListenerWrapper.GetListenerWrapper(listener).Increment().Process);
        ...
        /// <returns>Returns a reference to the EventEmitter, so that calls can be chained.</returns>
        [return: NotNullIfNotNull("eventEmitter")]
        public static TEventEmitter On<TEventEmitter, T1, T2, T3>([DisallowNull] this TEventEmitter eventEmitter,
                                                      [DisallowNull] string eventName,
                                                      [DisallowNull] Action<T1, T2, T3> listener)
            where TEventEmitter : IEventEmitter<TEventEmitter> => eventEmitter.On(eventName, ListenerWrapper.GetListenerWrapper(listener).Increment().Process);
        ...
        /// <returns>Returns a reference to the EventEmitter, so that calls can be chained.</returns>
        [return: NotNullIfNotNull("eventEmitter")]
        public static TEventEmitter On<TEventEmitter, T1, T2, T3, T4>([DisallowNull] this TEventEmitter eventEmitter,
                                                      [DisallowNull] string eventName,
                                                      [DisallowNull] Action<T1, T2, T3, T4> listener)
            where TEventEmitter : IEventEmitter<TEventEmitter> => eventEmitter.On(eventName, ListenerWrapper.GetListenerWrapper(listener).Increment().Process);
        ...
        /// <returns>Returns a reference to the EventEmitter, so that calls can be chained.</returns>
        [return: NotNullIfNotNull("eventEmitter")]
        public static TEventEmitter On<TEventEmitter, T1, T2, T3, T4, T5>([DisallowNull] this TEventEmitter eventEmitter,
                                                      [DisallowNull] string eventName,
                                                      [DisallowNull] Action<T1, T2, T3, T4, T5> listener)
            where TEventEmitter : IEventEmitter<TEventEmitter> => eventEmitter.On(eventName, ListenerWrapper.GetListenerWrapper(listener).Increment().Process);
        ...
        /// <returns>Returns a reference to the EventEmitter, so that calls can be chained.</returns>
        [return: NotNullIfNotNull("eventEmitter")]
        public static TEventEmitter On<TEventEmitter, T1, T2, T3, T4, T5, T6>([DisallowNull] this TEventEmitter eventEmitter,
                                                      [DisallowNull] string eventName,
                                                      [DisallowNull] Action<T1, T2, T3, T4, T5, T6> listener)
            where TEventEmitter : IEventEmitter<TEventEmitter> => eventEmitter.On(eventName, ListenerWrapper.GetListenerWrapper(listener).Increment().Process);
        ...
        /// <returns>Returns a reference to the EventEmitter, so that calls can be chained.</returns>
        [return: NotNullIfNotNull("eventEmitter")]
        public static TEventEmitter On<TEventEmitter, T1, T2, T3, T4, T5, T6, T7>([DisallowNull] this TEventEmitter eventEmitter,
                                                      [DisallowNull] string eventName,
                                                      [DisallowNull] Action<T1, T2, T3, T4, T5, T6, T7> listener)
            where TEventEmitter : IEventEmitter<TEventEmitter> => eventEmitter.On(eventName, ListenerWrapper.GetListenerWrapper(listener).Increment().Process);
        ...
        /// <returns>Returns a reference to the EventEmitter, so that calls can be chained.</returns>
        [return: NotNullIfNotNull("eventEmitter")]
        public static TEventEmitter On<TEventEmitter, T1, T2, T3, T4, T5, T6, T7, T8>([DisallowNull] this TEventEmitter eventEmitter,
                                                      [DisallowNull] string eventName,
                                                      [DisallowNull] Action<T1, T2, T3, T4, T5, T6, T7, T8> listener)
            where TEventEmitter : IEventEmitter<TEventEmitter> => eventEmitter.On(eventName, ListenerWrapper.GetListenerWrapper(listener).Increment().Process);
        ...
        /// <returns>Returns a reference to the EventEmitter, so that calls can be chained.</returns>
        [return: NotNullIfNotNull("eventEmitter")]
        public static TEventEmitter Once<TEventEmitter>([DisallowNull] this TEventEmitter eventEmitter,
                                                      [DisallowNull] string eventName,
                                                      [DisallowNull] Delegate listener)
        ...
        /// <returns>Returns a reference to the EventEmitter, so that calls can be chained.</returns>
        [return: NotNullIfNotNull("eventEmitter")]
        public static TEventEmitter Once<TEventEmitter, T1>([DisallowNull] this TEventEmitter eventEmitter,
                                                      [DisallowNull] string eventName,
                                                      [DisallowNull] Action<T1> listener)
            where TEventEmitter : IEventEmitter<TEventEmitter> => eventEmitter.Once(eventName, ListenerWrapper.GetListenerWrapper(listener).Increment().Process);
        ...
        /// <returns>Returns a reference to the EventEmitter, so that calls can be chained.</returns>
        [return: NotNullIfNotNull("eventEmitter")]
        public static TEventEmitter Once<TEventEmitter, T1, T2>([DisallowNull] this TEventEmitter eventEmitter,
                                                      [DisallowNull] string eventName,
                                                      [DisallowNull] Action<T1, T2> listener)
            where TEventEmitter : IEventEmitter<TEventEmitter> => eventEmitter.Once(eventName, ListenerWrapper.GetListenerWrapper(listener).Increment().Process);
        ...
        /// <returns>Returns a reference to the EventEmitter, so that calls can be chained.</returns>
        [return: NotNullIfNotNull("eventEmitter")]
        public static TEventEmitter Once<TEventEmitter, T1, T2, T3>([DisallowNull] this TEventEmitter eventEmitter,
                                                      [DisallowNull] string eventName,
                                                      [DisallowNull] Action<T1, T2, T3> listener)
            where TEventEmitter : IEventEmitter<TEventEmitter> => eventEmitter.Once(eventName, ListenerWrapper.GetListenerWrapper(listener).Increment().Process);
        ...
        /// <returns>Returns a reference to the EventEmitter, so that calls can be chained.</returns>
        [return: NotNullIfNotNull("eventEmitter")]
        public static TEventEmitter Once<TEventEmitter, T1, T2, T3, T4>([DisallowNull] this TEventEmitter eventEmitter,
                                                      [DisallowNull] string eventName,
                                                      [DisallowNull] Action<T1, T2, T3, T4> listener)
            where TEventEmitter : IEventEmitter<TEventEmitter> => eventEmitter.Once(eventName, ListenerWrapper.GetListenerWrapper(listener).Increment().Process);
        ...
        /// <returns>Returns a reference to the EventEmitter, so that calls can be chained.</returns>
        [return: NotNullIfNotNull("eventEmitter")]
        public static TEventEmitter Once<TEventEmitter, T1, T2, T3, T4, T5>([DisallowNull] this TEventEmitter eventEmitter,
                                                      [DisallowNull] string eventName,
                                                      [DisallowNull] Action<T1, T2, T3, T4, T5> listener)
            where TEventEmitter : IEventEmitter<TEventEmitter> => eventEmitter.Once(eventName, ListenerWrapper.GetListenerWrapper(listener).Increment().Process);
        ...
        /// <returns>Returns a reference to the EventEmitter, so that calls can be chained.</returns>
        [return: NotNullIfNotNull("eventEmitter")]
        public static TEventEmitter Once<TEventEmitter, T1, T2, T3, T4, T5, T6>([DisallowNull] this TEventEmitter eventEmitter,
                                                      [DisallowNull] string eventName,
                                                      [DisallowNull] Action<T1, T2, T3, T4, T5, T6> listener)
            where TEventEmitter : IEventEmitter<TEventEmitter> => eventEmitter.Once(eventName, ListenerWrapper.GetListenerWrapper(listener).Increment().Process);
        ...
        /// <returns>Returns a reference to the EventEmitter, so that calls can be chained.</returns>
        [return: NotNullIfNotNull("eventEmitter")]
        public static TEventEmitter Once<TEventEmitter, T1, T2, T3, T4, T5, T6, T7>([DisallowNull] this TEventEmitter eventEmitter,
                                                      [DisallowNull] string eventName,
                                                      [DisallowNull] Action<T1, T2, T3, T4, T5, T6, T7> listener)
            where TEventEmitter : IEventEmitter<TEventEmitter> => eventEmitter.Once(eventName, ListenerWrapper.GetListenerWrapper(listener).Increment().Process);
        ...
        /// <returns>Returns a reference to the EventEmitter, so that calls can be chained.</returns>
        [return: NotNullIfNotNull("eventEmitter")]
        public static TEventEmitter Once<TEventEmitter, T1, T2, T3, T4, T5, T6, T7, T8>([DisallowNull] this TEventEmitter eventEmitter,
                                                      [DisallowNull] string eventName,
                                                      [DisallowNull] Action<T1, T2, T3, T4, T5, T6, T7, T8> listener)
            where TEventEmitter : IEventEmitter<TEventEmitter> => eventEmitter.Once(eventName, ListenerWrapper.GetListenerWrapper(listener).Increment().Process);
    }
